                ...
                <div className="u-marginTop--30">
                  ...
                  <div className="u-marginTop--20">
                    ...
                    <div className="AppList--wrapper flex flexWrap--wrap">
                      ...
                      <li className="u-fontSize--small u-color--dustyGray u-fontWeight--medium u-lineHeight--normal"> CentOS 7.4, 7.5, 7.6, 7.7, 7.8, 8.1, 8.2 (CentOS 8.x requires Containerd) </li>
                      <li className="u-fontSize--small u-color--dustyGray u-fontWeight--medium u-lineHeight--normal"> RHEL 7.4, 7.5, 7.6, 7.7, 7.8, 8.1, 8.2 (RHEL 8.x requires Containerd) </li>
