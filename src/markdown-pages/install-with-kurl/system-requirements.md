...
For more information on configuring load balancers in the public cloud for kURL installs see [Configuring Public Cloud Load Balancers](/docs/install-with-kurl/configuring-public-cloud-load-balancers).
