...
For online installations, the only supported way to upgrade from Rook `1.0.x` to `1.4.9` is with `curl https://k8s.kurl.sh/latest/tasks.sh | sudo bash -s rook_10_to_14`.
