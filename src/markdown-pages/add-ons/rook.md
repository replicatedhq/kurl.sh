...
This will migrate data off of any hostpath-based OSDs in favor of block device-based OSDs and upgrade through Rook `1.1.9`, `1.2.7` and `1.3.11` before installing `1.4.9`. The upstream Rook project introduced a requirement for block storage in versions 1.4.x and later. 
